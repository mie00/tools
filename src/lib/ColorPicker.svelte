...
<div class="space-y-6">
	<div class="text-center">
		<h2 class="text-2xl font-bold text-gray-800 mb-2">Color Picker</h2>
	...
	<div class="text-center">
		<div 
			class="w-32 h-32 mx-auto rounded-full border-4 border-gray-300 shadow-lg"
			style="background-color: {selectedColor};"
		></div>
		<p class="mt-2 text-lg font-mono">{selectedColor}</p>
	</div>
        ...
        <input
          id="rgb-r"
			...
			<div class="flex gap-1 text-sm">
				<input type="number" min="0" max="255" bind:value={rgbR} on:input={updateFromRgb} class="w-16 px-2 py-1 border rounded" />
				<input type="number" min="0" max="255" bind:value={rgbG} on:input={updateFromRgb} class="w-16 px-2 py-1 border rounded" />
				<input type="number" min="0" max="255" bind:value={rgbB} on:input={updateFromRgb} class="w-16 px-2 py-1 border rounded" />
				<button
      ...
      <div class="space-y-1">
        <input
          id="hsl-h"
			...
			<div class="flex gap-1 text-sm">
				<input type="number" min="0" max="360" bind:value={hslH} on:input={updateFromHsl} class="w-16 px-2 py-1 border rounded" />
				<input type="number" min="0" max="100" bind:value={hslS} on:input={updateFromHsl} class="w-16 px-2 py-1 border rounded" />
				<input type="number" min="0" max="100" bind:value={hslL} on:input={updateFromHsl} class="w-16 px-2 py-1 border rounded" />
				<button
  ...
  <div class="space-y-2">
    <span class="block text-sm font-medium text-gray-700">Color Variants</span>
		<div class="grid grid-cols-3 gap-4">
			...
			<div class="text-center">
				<div class="w-16 h-16 mx-auto rounded-lg border border-gray-300" style="background-color: {selectedColor};"></div>
				<p class="mt-1 text-sm">Original</p>
			</div>
			<div class="text-center">
				<div class="w-16 h-16 mx-auto rounded-lg border border-gray-300" style="background-color: {darkerColor};"></div>
				<p class="mt-1 text-sm">Darker</p>
			</div>
		</div>
		<div class="text-center mt-4">
			<div class="w-16 h-16 mx-auto rounded-lg border border-gray-300" style="background-color: {complementaryColor};"></div>
