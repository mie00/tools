...
<div class="rounded-xl bg-white p-8 shadow-lg">
	...
	<div class="mt-8">
		...
		<div class="grid gap-4 md:grid-cols-3 lg:grid-cols-6">
			<div>
				...
				<input
					...
					class="w-full rounded-lg border border-gray-300 px-3 py-2 text-center focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
				/>
			</div>
			<div>
		...
		<p class="mt-2 text-sm text-gray-600">Positive values add time, negative values subtract time</p>
	</div>
