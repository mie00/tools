<script>
	...
	function inputNumber(num) {
		if (waitingForOperand || shouldResetDisplay) {
			...
			if (display.replace(/,/g, '').length < 9) { // Limit to 9 digits like Apple
...
<div class="calculator">
	...
	<div class="button-grid">
		...
		<button class="button function" on:click={toggleSign}>
			±
		</button>
		<button class="button function" on:click={percentage}>
			%
		</button>
		<button class="button operator" on:click={() => performOperation('÷')}>
			÷
		</button>
		
		<!-- Row 2 -->
		<button class="button number" on:click={() => inputNumber(7)}>
			7
		</button>
		<button class="button number" on:click={() => inputNumber(8)}>
			8
		</button>
		<button class="button number" on:click={() => inputNumber(9)}>
			9
		</button>
		<button class="button operator" on:click={() => performOperation('×')}>
			×
		...
		<!-- Row 3 -->
		<button class="button number" on:click={() => inputNumber(4)}>
			4
		</button>
		<button class="button number" on:click={() => inputNumber(5)}>
			5
		</button>
		<button class="button number" on:click={() => inputNumber(6)}>
			6
		</button>
		<button class="button operator" on:click={() => performOperation('−')}>
			−
		...
		<!-- Row 4 -->
		<button class="button number" on:click={() => inputNumber(1)}>
			1
		</button>
		<button class="button number" on:click={() => inputNumber(2)}>
			2
		</button>
		<button class="button number" on:click={() => inputNumber(3)}>
			3
		</button>
		<button class="button operator" on:click={() => performOperation('+')}>
			+
		...
		<!-- Row 5 -->
		<button class="button number zero" on:click={() => inputNumber(0)}>
			0
		</button>
		<button class="button number" on:click={inputDecimal}>
			.
		</button>
		<button class="button operator" on:click={handleEquals}>
			=
		</button>
	</div>
</div>
